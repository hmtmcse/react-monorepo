...
export default class TRTableAction extends TRReactComponent<TRTableActionProps, TRTableActionState> {
    ...
    xyz(){
        // {this.state.showConfirmation ? (<TRAlertDialog
        //     isOpen={this.state.showConfirmation}
        //     message={this.state.confirmProps.message}
        //     okayFunction={this.state.confirmProps.okayFunction}
        //     okayLabel={this.state.confirmProps.okayLabel}
        //     cancelFunction={this.state.confirmProps.cancelFunction}
        //     cancelLabel={this.state.confirmProps.cancelLabel}
        //     onCloseCallbackData={this.state.confirmProps.onCloseCallbackData}
        // />) : ""}
    }
}